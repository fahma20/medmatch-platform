...
const Clients = () => {
  ...
  return (
    <div className="container my-4">
      <h2 className="text-center mb-4 text-white">Clients Management</h2>
      ...
      >
        <Form>
          ...
          <button type="submit" className="btn" style={{ backgroundColor: '#005f73', color: '#ffffff', width: '100%' }}>
      ...
      {/* Clients List */}
      <div className="mt-4">
        <h3 className="text-white">Clients List</h3>
        {loading ? (
          ...
          <p className="text-center text-white">No clients available.</p>
        ) : (
          <div className="row">
            {clients.map((client) => (
              <div key={client.id} className="col-md-4 mb-4">
                <div className="card shadow-sm" style={{ backgroundColor: '#e0f3f3', border: 'none' }}>
                  <div className="card-body">
                    {/* Changed client name color */}
                    <h5 className="card-title" style={{ color: '#005f73' }}>{client.name}</h5>
                    <p className="card-text"><strong>Email:</strong> {client.email}</p>
                    <button
                      className="btn"
                      style={{ backgroundColor: '#0a9396', color: '#ffffff', width: '100%' }}
