...
const Clients = () => {
  ...
  return (
    <div className="container my-4">
      <h2 className="text-center mb-4 text-success">Clients Management</h2>
      ...
      >
        <Form>
          <div className="form-group mb-3">
            <label htmlFor="name" className="text-success">Client Name</label>
            <Field
              type="text"
              id="name"
              name="name"
          ...
          <div className="form-group mb-3">
            <label htmlFor="email" className="text-success">Client Email</label>
            <Field
              type="email"
              id="email"
              name="email"
      ...
      {/* Clients List */}
      <div className="mt-4">
        <h3 className="text-success">Clients List</h3>
        {loading ? (
          ...
          <div className="row">
            {clients.map((client) => (
              <div key={client.id} className="col-md-4 mb-4">
                <div className="card shadow-sm hover-shadow" style={{ border: '1px solid #28a745' }}>
                  <div className="card-body">
                    {/* Changed client name color */}
                    <h5 className="card-title text-success">{client.name}</h5> {/* Added text-success for green color */}
