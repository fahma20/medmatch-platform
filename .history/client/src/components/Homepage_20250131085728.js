    ...
    <div className="container-fluid">
      ...
      <section className="hero bg-primary text-white py-5">
        <div className="container text-center">
          ...
          <Link to="/healthcare-professionals" className="btn btn-light btn-lg">Manage Doctors & Staff</Link>
        </div>
      </section>
      ...
      <section className="features py-5">
        <div className="container text-center">
          <h2 className="font-weight-bold mb-4">Hospital Management Features</h2>
          <div className="row">
            {/* Doctors & Staff Management */}
            <div className="col-lg-4 mb-4">
              <div className="card shadow-sm">
                <div className="card-body">
                  <h4 className="card-title text-primary">Doctors & Staff</h4>
                  ...
                  <Link to="/healthcare-professionals" className="btn btn-outline-primary">Manage Doctors</Link>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 mb-4">
              <div className="card shadow-sm">
                <div className="card-body">
                  <h4 className="card-title text-primary">Specializations</h4>
                  ...
                  <Link to="/specializations" className="btn btn-outline-primary">Manage Specializations</Link>
                </div>
              </div>
            </div>
