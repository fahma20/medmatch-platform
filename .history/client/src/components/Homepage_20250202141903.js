        ...
        <div className="container text-center">
          ...
          <div className="row">
            ...
            <div className="col-lg-4 mb-4">
              <div className="card shadow-lg border-0 rounded-lg bg-dark text-white">
                <div className="card-body">
                  <h4 className="card-title text-white mb-3">Doctors & Staff</h4>
                  <p className="card-text text-muted mb-4">
                    Manage hospital doctors, staff, their details, and specializations. Perform CRUD operations with ease.
                  </p>
                  <Link to="/healthcare-professionals" className="btn btn-light btn-lg">
                    Manage Doctors
                  </Link>
                </div>
              </div>
            ...
            <div className="col-lg-4 mb-4">
              <div className="card shadow-lg border-0 rounded-lg bg-dark text-white">
                <div className="card-body">
                  <h4 className="card-title text-white mb-3">Specializations</h4>
                  <p className="card-text text-muted mb-4">
                    Add, edit, or delete specializations offered by your hospital. Organize and manage services effectively.
                  </p>
                  <Link to="/specializations" className="btn btn-light btn-lg">
            ...
            <div className="col-lg-4 mb-4">
              <div className="card shadow-lg border-0 rounded-lg bg-dark text-white">
                <div className="card-body">
                  <h4 className="card-title text-white mb-3">Appointments</h4>
                  <p className="card-text text-muted mb-4">
        ...
        <div className="container text-center">
          ...
          <div className="row">
            <div className="col-md-4">
              <div className="card shadow-lg border-0 rounded-lg bg-dark text-white mb-4">
                <div className="card-body">
