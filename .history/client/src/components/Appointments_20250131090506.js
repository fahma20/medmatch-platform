...
const Appointments = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setMessage(`Appointment scheduled with Dr. ${result.healthcare_professional} for ${result.appointment_date}`);
            } else {
    ...
    return (
        <div className="container mt-4" style={{ backgroundColor: '#f7f8fa', padding: '30px', borderRadius: '8px' }}>
            <h2 style={{ color: '#005f73' }}>Schedule an Appointment</h2>
