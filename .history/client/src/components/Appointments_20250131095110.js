...
const Appointments = () => {
    ...
    const [appointments, setAppointments] = useState([]);
    const [appointmentDateTime, setAppointmentDateTime] = useState(''); // single state for datetime
    ...
    const handleSubmit = async (e) => {
        ...
        const newAppointment = {
            ...
            date_time: appointmentDateTime, // using the combined datetime field
        };
    ...
    // Function to split date_time into date and time
        ...
        <div className="container mt-4">
            ...
            <div className="mt-4">
                ...
                <table className="table table-bordered">
                    ...
                    <tbody>
                        {appointments.map((appointment) => {
                            const { date, time } = splitDateTime(appointment.date_time); // Split datetime into date and time
                            return (
