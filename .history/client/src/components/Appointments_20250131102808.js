...
const Appointments = () => {
    ...
    const [appointmentTimeAMPM, setAppointmentTimeAMPM] = useState('AM'); // AM/PM state
    ...
    const handleSubmit = async (e) => {
        ...
        // Combine the date and time with AM/PM
        const fullDateTime = `${appointmentDate} ${appointmentTime} ${appointmentTimeAMPM}`;
                ...
                <div className="form-group mt-3">
                    ...
                    <div className="d-flex">
                        ...
                        <select
                            ...
                            value={appointmentTimeAMPM}
                            onChange={(e) => setAppointmentTimeAMPM(e.target.value)}
                        >
                    ...
                    <tbody>
                        {appointments.map((appointment) => (
                            <tr key={appointment.id}>
                                ...
                                <td>{appointment.datetime.split(' ')[0]}</td>
                                <td>{appointment.datetime.split(' ')[1]}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
