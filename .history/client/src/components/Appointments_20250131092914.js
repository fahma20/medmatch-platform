...
const Appointments = () => {
  ...
  return (
    <div className="container mt-4">
      <h2 className="text-center mb-4" style={{ color: '#007bff' }}>Manage Appointments</h2>

      {/* Appointment creation form */}
      <form onSubmit={handleSubmit} className="bg-light p-4 rounded shadow-sm">
        <div className="form-group">
          <label className="font-weight-bold" style={{ color: '#007bff' }}>Select Client (ID)</label>
          <select
            className="form-control"
            value={clientId}
        ...
        <div className="form-group mt-3">
          <label className="font-weight-bold" style={{ color: '#007bff' }}>Select Healthcare Professional (ID)</label>
          <select
            className="form-control"
        ...
        <div className="form-group mt-3">
          <label className="font-weight-bold" style={{ color: '#007bff' }}>Appointment Date</label>
          <input
            type="date"
            className="form-control"
        ...
        <div className="form-group mt-3">
          <label className="font-weight-bold" style={{ color: '#007bff' }}>Appointment Time</label>
          <input
            type="time"
            className="form-control"
      ...
      <h3 className="mt-5" style={{ color: '#007bff' }}>Existing Appointments</h3>
