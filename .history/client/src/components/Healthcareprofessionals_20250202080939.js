...
const HealthcareProfessional = () => {
  ...
  const handleDeleteSpecialization = async (healthcareProfessionalId, specializationId) => {
    try {
      ...
      if (response.ok) {
        setProfessionals((prevProfessionals) =>
          prevProfessionals.map((professional) =>
            professional.id === healthcareProfessionalId
              ? {
                  ...professional,
                      ...
                      professional.specializations.map((specialization) => (
                        <ListGroup.Item key={specialization.id}>
                          ...
                          <Button
                            ...
                            size="sm"
                            className="ml-2"
                            onClick={() => handleDeleteSpecialization(professional.id, specialization.id)}
                          >
