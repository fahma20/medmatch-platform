...
class Client(db.Model):
    ...
    appointments = db.relationship('Appointment', backref='client', lazy=True)  # Use 'client' as the backref
...
class Appointment(db.Model):
    ...
    client = db.relationship('Client', backref='appointments', lazy=True)  # The backref matches the one in Client
